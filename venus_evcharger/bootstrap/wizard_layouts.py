...
from venus_evcharger.bootstrap.wizard_adapters import native_charger_config, template_switch_group_files
from venus_evcharger.bootstrap.wizard_split_layouts import split_topology_files
from venus_evcharger.bootstrap.wizard_support import base_url_from_input
...
ProfileRenderer = Callable[
    [dict[str, str], str | None, str | None, str, str, float | None, str, str, str, int, str, int],
