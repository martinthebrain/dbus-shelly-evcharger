        ...
        return normalized_state_api_config_effective_fields(
            {
                ...
                "state": {
                    ...
                    "companion_source_grid_services_enabled": bool(
                        getattr(self, "companion_source_grid_services_enabled", False)
                    ),
                    "companion_source_grid_hold_seconds": float(getattr(self, "companion_source_grid_hold_seconds", 0.0)),
                    "companion_source_grid_smoothing_alpha": float(
                        getattr(self, "companion_source_grid_smoothing_alpha", 1.0)
                    ),
                    ...
                    "companion_source_pvinverter_service_prefix": getattr(
                        self, "companion_source_pvinverter_service_prefix", ""
                    ),
