...
class _ControlApiStateVictronMixin:
    def _state_api_victron_bias_recommendation_payload(self) -> dict[str, Any]:
        metrics = getattr(self, "_last_auto_metrics", {}) or {}
        raw_learning_profiles = getattr(self, "_victron_ess_balance_learning_profiles", {})
        ...
        state = {
            ...
            "current_kp": getattr(self, "auto_battery_discharge_balance_victron_bias_kp", 0.0),
            "current_ki": getattr(self, "auto_battery_discharge_balance_victron_bias_ki", 0.0),
            "current_kd": getattr(self, "auto_battery_discharge_balance_victron_bias_kd", 0.0),
            "current_deadband_watts": getattr(self, "auto_battery_discharge_balance_victron_bias_deadband_watts", 0.0),
            "current_max_abs_watts": getattr(self, "auto_battery_discharge_balance_victron_bias_max_abs_watts", 0.0),
            ...
            "recommended_deadband_watts": metrics.get(
                "battery_discharge_balance_victron_bias_recommended_deadband_watts"
            ),
            "recommended_max_abs_watts": metrics.get(
            ...
            "recommendation_confidence": metrics.get(
            ...
            "recommendation_profile_key": metrics.get(
            ...
            "recommendation_ini_snippet": metrics.get(
            ...
            "overshoot_cooldown_reason": metrics.get(
                "battery_discharge_balance_victron_bias_overshoot_cooldown_reason"
            ),
            "overshoot_cooldown_until": metrics.get(
            ...
            "oscillation_lockout_reason": metrics.get(
                "battery_discharge_balance_victron_bias_oscillation_lockout_reason"
            ),
            "oscillation_lockout_until": metrics.get(
            ...
            "auto_apply_suspend_reason": metrics.get(
                "battery_discharge_balance_victron_bias_auto_apply_suspend_reason"
            ),
            "auto_apply_suspend_until": metrics.get(
            ...
            "adaptive_tuning": {
                ...
                "topology_key": metrics.get("battery_discharge_balance_victron_bias_topology_key"),
                "source_id": metrics.get("battery_discharge_balance_victron_bias_source_id"),
                "kp": getattr(self, "auto_battery_discharge_balance_victron_bias_kp", 0.0),
                "ki": getattr(self, "auto_battery_discharge_balance_victron_bias_ki", 0.0),
                "kd": getattr(self, "auto_battery_discharge_balance_victron_bias_kd", 0.0),
                "deadband_watts": getattr(self, "auto_battery_discharge_balance_victron_bias_deadband_watts", 0.0),
                "max_abs_watts": getattr(self, "auto_battery_discharge_balance_victron_bias_max_abs_watts", 0.0),
                ...
                "auto_apply_last_applied_param": metrics.get(
                ...
                "last_stable_tuning": dict(getattr(self, "_victron_ess_balance_last_stable_tuning", {}) or {}),
                "last_stable_at": getattr(self, "_victron_ess_balance_last_stable_at", None),
                "last_stable_profile_key": getattr(self, "_victron_ess_balance_last_stable_profile_key", ""),
                "conservative_tuning": dict(getattr(self, "_victron_ess_balance_conservative_tuning", {}) or {}),
                "auto_apply_suspend_until": metrics.get(
                    "battery_discharge_balance_victron_bias_auto_apply_suspend_until"
                ),
                "auto_apply_suspend_reason": metrics.get(
