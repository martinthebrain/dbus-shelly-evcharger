...
class _ControlApiStateOperationalMixin:
    def _state_api_operational_payload(self) -> dict[str, Any]:
        ...
        learning_summary = summarize_energy_learning_profiles(
            learning_profiles if isinstance(learning_profiles, dict) else {}
        )
        ...
        last_auto_metrics = getattr(self, "_last_auto_metrics", {}) or {}
        return normalized_state_api_operational_fields(
            {
                ...
                "state": {
                    ...
                    "battery_discharge_balance_warning_active": bool(
                        last_auto_metrics.get("battery_discharge_balance_warning_active")
                    ),
                    ...
                    "battery_discharge_balance_bias_mode": last_auto_metrics.get(
                    ...
                    "combined_battery_inverter_source_count": worker_snapshot.get(
