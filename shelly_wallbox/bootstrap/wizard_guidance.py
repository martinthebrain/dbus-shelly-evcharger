...
from shelly_wallbox.bootstrap.wizard_models import WizardChargerBackend
from shelly_wallbox.bootstrap.wizard_policy_guidance import policy_defaults, prompt_policy_defaults
from shelly_wallbox.bootstrap.wizard_support import SPLIT_PRESET_LABELS, SPLIT_PRESET_VALUES, host_from_input
from shelly_wallbox.bootstrap.wizard_transport_guidance import (
    GOE_REQUEST_TIMEOUT_DEFAULT,
...
def apply_split_preset_backend(split_preset: str | None, backend: WizardChargerBackend | None) -> WizardChargerBackend | None:
