...
from shelly_wallbox.bootstrap.wizard_adapters import (
...
from shelly_wallbox.bootstrap.wizard_support import host_from_input
...
def _simple_split_variant(
    ...
    if split_preset == "shelly-io-modbus-charger":
        return _shelly_io_modbus_files(role_hosts, transport_kind, transport_host, transport_port, transport_device, transport_unit_id)
