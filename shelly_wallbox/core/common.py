...
from shelly_wallbox.core import common_schedule as _common_schedule_module
from shelly_wallbox.core.common_auto import (
    _age_seconds,
    _auto_state_code,
    _base_auto_reason,
...
from shelly_wallbox.core.common_values import (
