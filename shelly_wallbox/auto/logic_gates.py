...
from shelly_wallbox.core.common import confirmed_relay_state_max_age_seconds as _confirmed_relay_state_max_age_seconds
from shelly_wallbox.core.contracts import cutover_confirmed_off
