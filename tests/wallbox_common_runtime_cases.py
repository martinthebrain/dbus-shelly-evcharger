...
from shelly_wallbox.core.common_types import _a, _kwh, _status_label, _v, _w
from shelly_wallbox.core.common_schedule import (
...
class TestShellyWallboxCommonRuntime(unittest.TestCase):
    ...
    def test_common_auto_now_helper_ignores_boolean_time_callback_values(self):
        ...
        with patch("shelly_wallbox.core.common_auto.time.time", return_value=123.0):
    ...
    def test_common_auto_now_helper_falls_back_when_service_has_no_time_callback(self):
        ...
        with patch("shelly_wallbox.core.common_auto.time.time", return_value=321.0):
