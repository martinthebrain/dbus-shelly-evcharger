...
class _TestVenusEvchargerStateContractsPart2:
    def test_operational_state_contract_normalizes_known_fields(self) -> None:
        state = normalized_state_api_operational_state_fields(
            {
                ...
                "auto_decision": {
                    ...
                    "state_code": 999,
                    "relay_intent": "1",
                    "surplus_watts": "1840.5",
                    "grid_watts": "-120.5",
                    "soc_percent": "61",
                    "start_threshold_watts": "1850",
                    "stop_threshold_watts": "1350",
                    "profile": " normal ",
        ...
        self.assertEqual(
            state["auto_decision"],
            {
                ...
                "grid_watts": -120.5,
                "soc_percent": 61.0,
                "start_threshold_watts": 1850.0,
                "stop_threshold_watts": 1350.0,
                "profile": "normal",
                "threshold_mode": "adaptive",
            },
        )
