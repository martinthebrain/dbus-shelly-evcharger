...
from shelly_wallbox.backend.shelly_io_split import ShellyIoSplitMixin
from shelly_wallbox.controllers.state_summary import _StateSummaryMixin
from shelly_wallbox.core.common_auto import _charger_transport_now
from shelly_wallbox.publish.dbus_core import _DbusPublishCoreMixin
from shelly_wallbox.runtime.audit_fields import _RuntimeSupportAuditFieldsMixin
...
class TestShellyWallboxBranchMisc(unittest.TestCase):
    def test_bootstrap_runtime_reuses_existing_state_controller(self) -> None:
        ...
        with (
            patch("shelly_wallbox.bootstrap.runtime.RuntimeSupportController") as runtime_controller,
            patch("shelly_wallbox.bootstrap.runtime.AutoDecisionController"),
            patch("shelly_wallbox.bootstrap.runtime.DbusPublishController"),
            patch("shelly_wallbox.bootstrap.runtime.ShellyIoController"),
            patch("shelly_wallbox.bootstrap.runtime.build_service_backends", return_value=resolved),
            patch("shelly_wallbox.bootstrap.runtime.ServiceStateController") as state_controller_cls,
            patch("shelly_wallbox.bootstrap.runtime.DbusWriteController"),
            patch("shelly_wallbox.bootstrap.runtime.AutoInputSupervisor"),
            patch("shelly_wallbox.bootstrap.runtime.UpdateCycleController"),
        ):
