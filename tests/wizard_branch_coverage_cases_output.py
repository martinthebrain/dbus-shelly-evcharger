...
class _WizardBranchCoverageOutputCases:
    def test_result_text_covers_optional_sections_and_live_check_rendering(self) -> None:
        ...
        self.assertIn("Hardware flow: the Shelly-compatible device measures energy and switches", preview_text)
        ...
        self.assertIn("Shelly-style metering/switching setups infer charging", preview_text)
